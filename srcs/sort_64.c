...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2018/06/10 14:46:57 by mpinson           #+#    #+#             */
/*   Updated: 2018/06/10 14:46:58 by mpinson          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
char		**sort_name(struct nlist_64 *array, int max, char *str, t_gen *g)
{
	int		is_sort;
	int		i;
	char	**val1;
	...
	if (!(val1 = ft_test_error_64(str, array, max, g)))
		return (NULL);
	is_sort = 1;
	while (is_sort)
	{
...
char		**revers_sort(struct nlist_64 *array, int max, char *str, t_gen *g)
{
	int		is_sort;
	int		i;
	char	**val1;
...
int			mamange_sort_nm_64(t_gen *g, int nsyms,
