...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2018/06/10 14:34:57 by mpinson           #+#    #+#             */
/*   Updated: 2018/06/10 14:35:05 by mpinson          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int			fat_32_revers(t_gen *g)
{
	...
	nm((void*)g->ptr + revers_uint32(fat_arch[save].offset),
...
int			fat_64(t_gen *g)
{
	...
	nm((void*)g->ptr + fat_arch[save].offset,
